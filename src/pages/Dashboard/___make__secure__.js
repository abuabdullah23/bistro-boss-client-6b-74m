 ...
 *   use AdminRoute that will check weather the user is admin or not, if not admin then redirect to any other page. you could logout user and send them to the login page as well.
 * 
 * -----------------------------
 * TO SEND DATA
 * ----------------------------
